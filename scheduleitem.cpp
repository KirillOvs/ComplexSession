...
void ScheduleItem::storeIntersectionRange(Range* range) const
{
    m_intersectionRanges.emplace_back(range);
}

std::vector<RangePtr>& ScheduleItem::getIntersectionRangesArray() const
{
